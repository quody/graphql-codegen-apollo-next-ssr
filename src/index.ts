...
export const plugin: PluginFunction<ApolloNextSSRRawPluginConfig, Types.ComplexPluginOutput> = (
  ...
  const visitor = new ApolloNextSSRVisitor(schema, allFragments, config, documents);
